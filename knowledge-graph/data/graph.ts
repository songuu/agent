...
export const CONCEPTS: Concept[] = [
  ...
  { id: "srca-repository-matrix", label: "仓库矩阵解析器", chapter: "21", summary: "输入 GitHub 仓库后生成目录/包矩阵、Relevant Source Files、语言分布和阅读路径" },
...
export const ARTICLES: Article[] = [
  ...
  { title: "DeepWiki", url: "https://deepwiki.com/", kind: "doc", source: "DeepWiki", chapters: ["21"], note: "源码仓库 Wiki 参考形态：仓库入口、目录化 Wiki、Relevant source files 和源码引用" },
