...
> 简言之：**第 08/09 章理解 RAG → 进阶 RAG 专题在本仓库内做到生产级 → [RAG 完整架构蓝图](./rag-architecture.md) 建系统边界 → `songuu/rag-system` 沉淀为独立作品集项目。**
...
6. 打开 [songuu/rag-system](https://github.com/songuu/rag-system)，重点对照这些模块:
   - 文档导入与解析；
   - chunk 策略；
   - embedding 与向量存储；
   - 检索、rerank、上下文组装；
