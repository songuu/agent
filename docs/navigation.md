...
| Agent 工程化 / Context / PromptOps | [五平面架构](./agent-trends-architecture.md) → [A1 Run Contract](../agent-engineering/01-run-contract/README.md) → [A2 Context Compiler](../agent-engineering/02-context-compiler/README.md) → [A3 Prompt Release Gate](../agent-engineering/03-prompt-release-gate/README.md) → [15 评估](../lessons/15-evaluation-and-testing/README.md) |
