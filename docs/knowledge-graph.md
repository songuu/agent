...
共 **45** 个单元、**267** 个概念、**414** 条关系、**165** 篇关联文章。
...
| 仓库矩阵解析器 | [21 源码解析](../source-analysis/README.md) | 输入 GitHub 仓库后生成目录/包矩阵、Relevant Source Files、源码问答、语言分布和阅读路径 |
...
| [DeepWiki](https://deepwiki.com/) | DeepWiki | doc | 21 | 源码仓库 Wiki 参考形态：仓库入口、目录化 Wiki、Relevant source files、源码问答和源码引用 |
