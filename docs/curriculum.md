...
| 21.0 | 热门仓库与源码对话 | ⭐⭐⭐⭐ | 60 分钟 | 从热门库卡片或指定 GitHub 仓库进入，生成仓库矩阵、Relevant Source Files、源码行号回答、CodeMap 和阅读路径 | [../source-analysis/repository-matrix.md](../source-analysis/repository-matrix.md) |
