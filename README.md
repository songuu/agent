...
| 21.0 | [热门仓库与源码问答](./source-analysis/repository-matrix.md) | ⭐⭐⭐⭐ | 从热门库卡片或指定 GitHub 仓库进入，生成仓库矩阵、Relevant Source Files 和源码行号回答 |
...
- [**源码解析**](./source-analysis/)：先从热门库卡片或仓库矩阵解析器定位任意 GitHub 仓库的包/文件边界，再用源码问答检索 raw source 和行号引用，再顺着官方源码入口读 LangChain、LangGraph、LlamaIndex，把“会用框架”推进到“能看懂和调试框架”。
